...
<?php
    ...
    $image_title = get_the_title($image_id);
     ...
     $property_price = get_field('property_price',$id);
...
?>
                    ...
                    <div class="details-pavana-right-section">
                        <div class="details-pavana-right-first">
                            ...
                            <div class="details-pavana-right-price-description">
                                <p><span>Price :</span> Starting <?php echo $property_price;?></p>
    ...
    <div class="col-lg-12">
            <a href="" class="showhome-bow-btn22">Download Floorplan</a>
    </div>
    ...
    <input type='radio' class="myid" onchange="my_function('<?php echo get_field('email',$m_id); ?>')" value="<?php echo get_field('email',$m_id); ?>" id='radio_<?php echo $p; ?>' name='type' <?php if($p==1){echo 'checked';}?>>
                       ...
                       <form type="post" action="" id="newCustomerForm">
                        <input type="hidden" name="cus_mail" id="myText">
                          ...
                          <input type="hidden" name="action" value="get_data"/>
                           <button type="submit" id="Identification" name="submit" class="btn btn-submit">Request info</button>
                          </form>
       ...
       <div class="container">
           ...
           <div class="row">
               ...
               <div class="col-lg-4">
                   ...
                   <a href="<?php echo $book_a_tour_link['url']; ?>" class="showhome-bow-btn"><?php echo $book_a_tour_text; ?></a>
                   <?php } ?>
               </div>
    ...
    <section class="communities-featuring-pavanna">
       <div class="container">
           <div class="heading-box text-center">
                <h3 class="h3">Communities Featuring The Pavanna</h3>
         ...
         <div class="col-lg-4">
            ...
            <?php } else{?>
               ...
               <?php } ?>
                        ...
                        <?php if($area){?>
                         <li>
                             <div class="list-pro-option-bx"><img src="<?php echo get_template_directory_uri(); ?>/images/list-pro-icon3.png" alt=""> <span><?php echo $area;?></span></div>
                        </li>
                        <?php } ?>
