               ...
               <?php 
                ...
                ?>
                  <div class="find-home-search-input-bx">
                    ...
                    ?>
                       <option <?php if(get_the_ID()==$communities) {?> selected <?php } ?> value="<?php echo $slug;?>"><?php echo $community; ?></option>
               ...
               <!-- <div class="col-lg-4">
                  ...
                  <div class="col-lg-6">
                    ...
                    if(!in_array($bedrooms, $uniqArraybd)){
                      ...
                      if(!empty($bedrooms)){ 
                    ?>
                       <option  value="<?php echo $bedrooms;?>"><?php echo $bedrooms; ?></option>
                       <?php  } }
   endwhile; wp_reset_postdata(); ?>
                      </select>
                  </div>
...
echo $_GET['bed'].'<br>';
echo $_GET['btr'].'<br>';
echo $_GET['min-sqf'].'<br>';
echo $_GET['max-sqf'].'<br>';
...
if($communities){
  $meta_query[] = ['key'=> 'communities_choose','value'=>'edgemont-east'];
}
if($ht){
