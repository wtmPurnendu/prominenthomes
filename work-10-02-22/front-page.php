        ...
        <div class="int_content_wraapper int_content_left">
            ...
            <div class="banner-social-call-email">
                ...
                <ul class="list-inline ban-call">
                    <li><img src="<?php echo get_template_directory_uri(); ?>/images/call.png"> Call: <a href="tel:+17807610790">+1 780-761-0790</a></li>
                </ul>
                <ul class="list-inline ban-email">
                    <li><img src="<?php echo get_template_directory_uri(); ?>/images/email.png"> <a href="mailto:hello@prominenthomes.ca">hello@prominenthomes.ca</a></li>
                </ul>
            </div>
...
<?php endwhile; wp_reset_postdata(); ?> 
    ...
    <section class="main-area about-area">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="about-img-box"><img src="<?php echo get_template_directory_uri(); ?>/images/about-image.png" alt="#" title=""></div>
                </div>
                <div class="col-lg-7">
                    <div class="about-contain">
                        <h3 class="h3">About <strong>Us</strong></h3>
                        <p>Prominent Homes is a leading Alberta New Home Builder with offices in Calgary and Edmonton. With a long and rich history of quality craftsmanship and unwavering integrity, Prominent Homes has been helping families for over 30 years.</p>
                        <p>Prominent Homes is a leading Alberta New Home Builder with offices in Calgary and Edmonton. With a long and rich history of quality craftsmanship and unwavering integrity, Prominent Homes has been helping families for over 30 years.</p>
    ...
    <!-------- get help area start ---------->
    <section class="get-help-area" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/get-help-bg.jpg);">
        <div class="container">
            <div class="get-help-body">
                <h3>We Are Ready to</h3>
                <h4>Help You Get the Best Quality Room!</h4>
    ...
    <section class="main-area featured-project-area">
        <div class="container">
            <div class="heading-box text-center">
                <h3 class="h3">Featured <strong>Project</strong></h3>
                <p>Prominent Homes is a leading Alberta New Home Builder with offices in Calgary and Edmonton. With a long and rich history of quality craftsmanship.</p>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <div class="project-image-box img-one">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/project-image1.jpg" alt="project image" title="">
                        <a href="javascript:void(0);" data-fancybox="single" data-src="<?php echo get_template_directory_uri(); ?>/images/project-image1.jpg" class="image-zoom"><i class="zmdi zmdi-search"></i></a>
                    </div>
