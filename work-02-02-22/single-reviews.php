  ...
  <div class="container">
    ...
    <?php endif ?>
            ...
            <div class="d-flex justify-content-between">
              <div class="ratingBox">
               <?php if (get_field('total_out_of_review')): ?>
                ...
                <?php if (get_field('average_ratings_copy')): ?>
                  <p><?php echo get_field('average_ratings_copy');?></p>
                <?php else: ?>
                  <p>Avarage Ratings</p>
                <?php endif ?>
              ...
              <div class="ratingBoxTWO">
                ...
                ?>
                  <li>
                    <div class="number">
                      <?php echo get_field('location_ratings',$id); ?>  
                    </div>
                   <?php if(get_field('rating_title_1')){
                    the_field('rating_title_1'); 
                  } else { echo 'Location';
          ...
          <div class="review_box_two">
            ...
            <div class="d-flex justify-content-between">
              <ul class="lineBOX">
                <?php if (get_field('country',$id)): ?>
                  <li>Country  : <?php echo get_field('country',$id); ?></li>
                <?php endif ?>
                <?php if (get_field('city',$id)): ?>
                  <li>City : <?php echo get_field('city',$id); ?></li>
                <?php endif ?>
                <?php if (get_field('hotel',$id)): ?>
                  <li>Hotel :<?php echo get_field('hotel',$id); ?></li>
                <?php endif ?>
                
              </ul>
              <ul class="lineBOX">
                <?php if (get_field('rating',$id)): ?>
                  <li>Rating : <?php echo get_field('rating',$id); ?></li>
                <?php endif ?>
                <?php if (get_field('room',$id)): ?>
                  <li>Room : <?php echo get_field('room',$id); ?></li>
                <?php endif ?>
                <?php if (get_field('online',$id)): ?>
                  <li>Online :<?php echo get_field('online',$id); ?></li>
                <?php endif ?>
