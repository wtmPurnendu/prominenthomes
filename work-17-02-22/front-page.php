...
<?php if(get_field('home_property')) { ?> 
<?php foreach(get_field('home_property') as  $home) {
    //var_dump($home);
    ?>
<?php //echo $home['home_property_link']['url']; ?>
<div class="project-body">
    <div class="image-box"><img src="<?php echo $home['home_property_image']['url']; ?>" alt="<?php echo $home['home_property_image']['alt']; ?>" title="<?php echo $home['home_property_image']['name']; ?>"></div>
    <div class="project-contain-box">
        <h3 class="h3"><?php echo $home['home_property_title']; ?></h3>
        <p><?php echo $home['home_property_content']; ?></p>
        <a href="<?php echo $home['home_property_link']; ?>" class="btn"><?php echo $home['home_property_link_level']; ?></a>
    </div>
</div>
<?php } }?>
...
<div class="heading-box text-center">
    <h3 class="h3"><?php echo get_field('aour_homes_title'); ?></h3>
    <p><?php echo get_field('sour_homes_content'); ?></p>
</div>
